...
### Harjoitustietokantojen luonti

Luodaan koulutusta varten 2 eri tietokantaa. Luodaan ensin **trainingdatabase**-niminen
...
Vaikka **trainingdatabase** tuleekin olemaan pääasiallinen harjoitusten tietokanta, luodaan 
vielä toinen tietokanta myöhempää käyttöä varten. Annetaan tälle nimeksi vaikkapa **worlddatabase**.
Muutoin luonti sujuu samoja komentoja käyttäen.
...
Toista sama postgis-laajennoksen asennus myös **worlddatabase**-tietokantaan.
