...
triggeri. Samaten, jos kohteita halutaan poistaa tai muokata näkymän kautta, täytyy näille operaatiolle luoda omat INSTEAD OF -tyyppiset triggerinsä.
...
RETURNS trigger AS $$
BEGIN
  UPDATE helsinki.puurekisteri_piste
  SET wkb_geometry = NEW.wkb_geometry
  WHERE id = OLD.id;
...
INSTEAD OF UPDATE ON puut_kaupunginosittain
FOR EACH ROW
